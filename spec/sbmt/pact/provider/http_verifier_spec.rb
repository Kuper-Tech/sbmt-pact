...
describe Sbmt::Pact::Provider::HttpVerifier do
  subject { described_class.new(Sbmt::Pact::Provider::PactConfig::Http.new(provider_name: "provider")) }
  ...
  context "when verify_only is defined" do
    let(:verify_only) { ["consumer-1", "consumer-2"] }
